  ...
  return (
    <div className={`w-full ${containerClass} select-none`}>
      <motion.div layout className="flex flex-col gap-4">
        ...
        <motion.div
          layout
          className={`grid gap-3 sm:gap-4 ${activeId ? "grid-cols-2 md:grid-cols-3 lg:grid-cols-4" : "grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6"}`}
        >
