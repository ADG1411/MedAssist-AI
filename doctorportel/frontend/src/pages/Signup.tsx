  ...
  return (
    <div className="flex bg-[#EBF4FE] overflow-y-auto justify-center min-h-screen py-10 px-4 font-sans text-slate-800 relative w-full selection:bg-brand-blue selection:text-white md:items-center items-start">
      ...
      <div className="relative z-10 w-full max-w-[420px] mx-auto min-h-[700px] flex flex-col justify-start">
        ...
        {/* Logo Section */}
        <div className="flex flex-col items-center justify-center space-y-2 mb-10 select-none cursor-pointer">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 font-medium px-2">Sing up and improve your health today</p>
        </div>
        ...
        {/* Separator */}
        <div className="flex items-center justify-center mt-10 mb-8 select-none opacity-80 px-2">
