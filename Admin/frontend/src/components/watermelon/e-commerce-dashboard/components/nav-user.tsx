...
export function NavUser({
  ...
  return (
    <SidebarMenu>
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger render={<SidebarMenuButton size="lg" className="data-[state=open]:bg-neutral-500/30 bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground h-14 transition-colors duration-300 hover:shadow-sm cursor-pointer" />}><Avatar className="h-8 w-8 rounded-lg! bg-transparent border-none p-0 overflow-hidden">
                                  {user.avatar ? (
                                ...
                                </div><IconDotsVertical className="ml-auto size-4" /></DropdownMenuTrigger>
          <DropdownMenuContent
