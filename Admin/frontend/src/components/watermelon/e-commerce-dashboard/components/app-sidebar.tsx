      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem className="flex flex-col gap-3">
            <SidebarMenuButton className="data-[slot=sidebar-menu-button]:!p-1.5" render={<a href="#" />}><IconInnerShadowTop className="!size-5" /><span className="text-base font-semibold">Acme Inc.</span></SidebarMenuButton>
            <DropdownMenu>
              <DropdownMenuTrigger render={<SidebarMenuButton size="lg" className="data-[state=open]:bg-sidebar-accent bg-white dark:bg-neutral-900 shadow data-[state=open]:text-sidebar-accent-foreground h-15 px-3 border border-transparent dark:border-neutral-800 transition-colors duration-300 hover:shadow-md cursor-pointer" />}><div className="bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-md">
                                              <IconBrandAppgallery stroke={2} />
                                            </div><div className="grid flex-1 flex-col text-left leading-tighter">
                                            ...
                                            </div><ChevronsUpDown className="ml-auto text-neutral-500" /></DropdownMenuTrigger>
              <DropdownMenuContent
