                  ...
                  {transactions.map((transaction) => (
                    <TableRow key={transaction.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors duration-300 hover:shadow-sm cursor-pointer border-transparent hover:border-neutral-200 dark:hover:border-neutral-700">
                      ...
                      <TableCell className="py-2 lg:py-4 text-right">
                        <DropdownMenu>
                          <DropdownMenuTrigger render={<button className="p-1.5 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors focus:outline-none" />}><IconDotsVertical className="size-4 text-neutral-500" /></DropdownMenuTrigger>
